<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="arabic_default" %>
...
<a href="../default.aspx" style="color:#000;">ENGLISH</a>
<p id="tellaFriend">|</p>
...
<a href="contact.aspx">  <img src="imagesARB/contactNav.png" alt="Services" name="servNav"  width="74" height="90"></a> <a href="order.aspx"><img hspace="36" src="imagesARB/placeorderNav.png" alt="Calculator" name="calcNav" width="70" height="90"></a> <a href="location.aspx"><img src="imagesARB/calculatorNav.png" alt="Order" name="orderNav" width="76" height="90"></a> <a href="services.aspx"><img hspace="30" src="imagesARB/servicesNav.png" alt="ContactUs" name="contactNav" width="70" height="90"></a>
    ...
    <div class="container">
        <div class="content">
            <div align="right" id="runErrand">
                <img src="imagesARB/HomeImage.png" alt="RunErrands" name="runErrandsMain">
            </div>
            <div align="left" id="callUsNow">
                <h3 style="font-weight: bold;">
                    <a id="callNow" href="tel:800900900">اتصل على</a><br>
                    <a href="tel:800900900">800 900 900 </a>
                </h3>
            </div>
            <div align="left" id="callUs">
                <img src="imagesARB/order.png" alt="Order" name="orderMain" width="385" height="500">
                <div id="quickLink">
                    <a href="order.aspx" class="yellowBtn">اضغط هنا</a>
                </div>
            </div>
            <div class="indexOc" align="right" id="onlineCalc">
                <img vspace="17" src="imagesARB/calc.png" alt="Order" name="orderMain" width="325"
                    height="560">
                <div class="indexCc" id="calcYrOrder">
                    <a href="location.aspx" class="blackBtn">حساب طلبك</a>
                </div>
            </div>
            <div class="indexthumb" id="thumb" align="right">
                <img src="imagesARB/Thumbup.png" alt="Mashaweer" name="thumbUp" width="202" height="234">
            </div>
            <div class="indexTesti" align="center" id="quotes">
                <img src="imagesARB/homeTestimonial.png" alt="Mashaweer" name="testiMain" width="494"
                    height="292">
            </div>
        </div>
    </div>
