    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (prc != null)
        {
            ...
            if (vechileType == "1")
            {
                ...
                {
                    context.Response.Write(prc.MotorcyclePrice.Value.ToString("0.#####"));
                }
            }
            else
            {
                ...
                {
                    context.Response.Write(prc.CarPrice.Value.ToString("0.#####"));
                }
            }
        }
        else
