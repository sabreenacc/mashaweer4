...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <title>Mashaweer | Privacy Policy</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="page-titlebar">
        ...
        <div class="title-cntr">
            <div class="title-txt">
                Privacy Policy</div>
            <%--<a href="#" class="wall-link">Write On Mashaweer Wall</a>--%>
        </div>
    </div>
    <div class="page-content">
        ...
        <div class="faq-area">
            <p>
                <span class="htitle1">What information do we collect?</span>
            </p>
            <p>
                We collect information from you when you place an order or fill out a form. When
                ordering or registering on our site, as appropriate, you may be asked to enter your:
                name, e-mail address or phone number. You may, however, visit our site anonymously.
            ...
            <p>
                To process transactions Your information, whether public or private, will not be
                sold, exchanged, transferred, or given to any other company for any reason whatsoever,
            </p>
            <p>
                without your consent, other than for the express purpose of delivering the purchased
                product or service requested. ; To send periodic emails The email address you provide
            ...
            <p>
                ...
                certain information We use cookies to understand and save your preferences for future
                visits.</p>
            <p>
                &nbsp;</p>
            <p class="htitle1">
            ...
            <p>
                ...
                to our online privacy policy.</p>
            <p>
                &nbsp;
            </p>
            <p class="htitle1">
