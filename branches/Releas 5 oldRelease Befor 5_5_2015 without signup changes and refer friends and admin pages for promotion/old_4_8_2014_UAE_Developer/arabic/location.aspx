<%@ Page Language="C#" AutoEventWireup="true" CodeFile="location.aspx.cs" Inherits="arabic_location" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>Mashaweer UAE | Location</title>
...
<a href="../location.aspx" style="color:#000;">ENGLISH</a>
<p id="tellaFriend">|</p>
    ...
    <div class="container">
        <div class="content">
            <div id="heading" align="center">
                <img src="imagesARB/chooseCity.png" alt="Mashaweer" name="chooseLoc" width="700"
                    height="100">
            </div>
            <br>
            <div id="locCircles">
                <a href="uae.aspx">
                    <img hspace="15" src="imagesARB/acrossuae.png" alt="Mashaweer" name="uae" width="200"
                        height="200"></a><a href="sharjah.aspx"><img hspace="15" src="imagesARB/sharjah.png"
                            alt="Mashaweer" name="sharjah" width="200" height="200"></a><a href="dubai.aspx"><img
                                hspace="15" src="imagesARB/dubai.png" alt="Mashaweer" name="dubai" width="200"
                                height="200"></a><a href="comingsoon.aspx"><img hspace="15" src="imagesARB/abudhabi.png"
                                    alt="Mashaweer" name="abudhabi" width="200" height="200">
            </div>
            <br>
            <br>
            <br>
