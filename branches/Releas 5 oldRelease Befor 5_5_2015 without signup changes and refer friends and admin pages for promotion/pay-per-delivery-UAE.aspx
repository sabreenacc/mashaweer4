<%@ Page Title="MashaweerNewP2Driver" Language="C#" MasterPageFile="~/Site2ForLandingPages2.master" AutoEventWireup="true"
    CodeFile="pay-per-delivery-UAE.aspx.cs" Inherits="MashaweerNewP2Driver" %>

<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    
<div class="page-warp" style="margin-top: -2%;">
<div class="left">
    <img src="App_Themes/MainEn/images/MASHA-NEW-P2-DRIVER.png" style="width: 38%;float: right;margin-top: -3%;" />
</div>
    <div class="right">
        <div>
        <span class="short-desc2" style="color:#FFFDFD;font-size: 359%;line-height: 1em;">
            ARE YOU SHORT 
         </span>
            </div>
        <div>
        <span class="short-desc2" style="color:#000;font-size: 359%;line-height: 1em;">
        ON DRIVERS?
            </span>
            </div>
        <div>
         <span class="short-desc2" style="color:#000;font-size: 170%;line-height: 1.7em;">
        There is no point of hiring…
             </span>
        </div>
    </div>
    <div style="margin-top: 0.5%;" >
         <span class="short-desc" style="  color: #000;margin-left: -2%;font-size: 125%;line-height: 1em;">
       Let us take care of all your drivers /<br />
             messengers requirements.
             </span>
   ...
   <br />
    ...
    <div>
     <div style="margin-top: .7%;">
         <span class="short-desc" style="color:#000;margin-left: -2%;font-size:171%;font-weight: bold;">
        No More:</span>
    </div>
    <br />
     
             <div style="float: left;margin-left: 2%;margin-right: 3%;font-family: 'Helvetica';font-size: 141%;  line-height: 1.2em;">                 
             ...
             <div id="dvLeftList" style="float: left;margin-left: 8%;margin-right: 3%;font-family: 'Helvetica';font-size: 141%;  line-height: 1.2em;">               
                 <ul style="list-style-type:disc">
                 <li>Cost of Car & Maintenance</li>
                 <li>End Of Services Benefits</li>
                 <li>Vaction Salary</li>
                 <li>Visa Charges</li>
             </ul>
             </div>          
    
            <span class="short-desc" style="margin-top: 0%;display: inline-block;color:#000;margin-left: -2%;font-size:171%;font-weight: bold;">
            <font style="color:white"> Pay only for the errand you want,</font><br />
                when you want it.
            </span>
   </div>
     ...
     <form runat="server">
         <div class="container_" style="background-color:black;">
                         <div id="footer_" style="background-color: black;padding: 1%;width: 100%;bottom: 0px;right: 0px;
                             ...
                             <div id="footer2_" style="width:69%;right: 0px;
                ...
                <tr>
                    <td>
                        ...
                        <asp:RequiredFieldValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RequiredFieldValidator5" runat="server" ErrorMessage="*"
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:RequiredFieldValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RequiredFieldValidator2" runat="server" Display="Dynamic"
                ...
                <tr>
                    <td>
                        ...
                        <asp:RegularExpressionValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RegularExpressionValidator4" runat="server" ForeColor="Red"
                        ...
                        <asp:RequiredFieldValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RequiredFieldValidator9" runat="server" Display="Dynamic"
               ...
               <tr>
                    <td>
                        <asp:TextBox ID="EmailAddress" CssClass="txt-box" placeholder="Email Address:" style="background-color: #ecf0f1;margin-top: 1%;margin-left: 3%;"
                            runat="server" TabIndex="1"></asp:TextBox>
                       <asp:RegularExpressionValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RegularExpressionValidator1" runat="server" ForeColor="Red"
                            ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="EmailAddress" ValidationGroup="Valid"
                            Display="Dynamic" ErrorMessage="*"></asp:RegularExpressionValidator>
                        <asp:RequiredFieldValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RequiredFieldValidator1" runat="server" Display="Dynamic"
                        ...
                        <asp:RequiredFieldValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RequiredFieldValidator3" runat="server" Display="Dynamic"
                            ErrorMessage="*" ControlToValidate="HowWeCanHelp" ForeColor="Red" ValidationGroup="Valid"></asp:RequiredFieldValidator>
                                                 <asp:Button ID="Button1" Text="Submit" style="margin-left: 63%;font-size: 15px;width:88px;margin-top: 3%;background-color: black;" runat="server" OnClick="btnsend_Click" CssClass="normal-btn" ValidationGroup="Valid"/>
                                            </div>
                                        </fieldset>
                                    </div>
