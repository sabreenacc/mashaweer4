<%@ page title="" language="C#" masterpagefile="~/Admin/Admin.master" autoeventwireup="true" inherits="Admin_News_Default, App_Web_30bwmlfr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="search" width="100%" border="0" cellspacing="0" cellpadding="10px">
            <tr>
                ...
                <td>
                    ...
                    <uc1:ConfirmationMessage ID="cmDialog" Command="New.Delete" runat="server" />
                </td>
                <td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 15px 0 0 0">
        ...
        <tr>
            ...
            <td class="mid">
                ...
                <asp:ListView ID="lvNew" runat="server" DataSourceID="lnqNew">
                    <LayoutTemplate>
                                ...
                                <td id="Td1" runat="server">
                                    <table id="itemPlaceholderContainer" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr id="Tr2" runat="server" style="">
                                            <th scope="col" width="50%" id="Th1" runat="server">
                                                <asp:LinkButton ID="lnkName" OnClick="Sorting_Click" CommandArgument="Title" runat="server">عنوان الخبر</asp:LinkButton>
                                            </th>
                                            ...
                                            <th scope="col" width="15">
                                                <asp:LinkButton ID="LinkButton2" OnClick="Sorting_Click" CommandArgument="CreatedDate"
                                                    runat="server">تاريخ الإضافة</asp:LinkButton>
                                            </th>
                    ...
                    <ItemTemplate>
                        <tr class='row<%# (Container.DataItemIndex%2)==0 ? "1" : "2" %>' id='LvRow_<%# Eval("NewId") %>'>
                            <td style="text-align: right; padding-right: 10px">
                                <%# Eval("Title").ToString().SupName(60) %>
                            </td>
                            <td>
                                <%# (Eval("Language").ToString() == "1") ? "اللغة العربية" : "English"%>
                            </td>
                            <td>
                                <%#  DateTime.Parse(Eval("CreatedDate").ToString()).ToString("dddd d MMMM yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("ar-AE"))%>
                            </td>
                            <td>
                                <a href='addEdit.aspx?ID=<%#Eval("NewId") %>'>
                                    <img src='/App_Themes/Admin/images/edit-icon.png' width='20' height='20' />
                                </a>
                            </td>
                            <td>
                                <a href='#' onclick='Delete("<%# Eval("NewId")%>");'>
    ...
    <asp:LinqDataSource ID="lnqNew" runat="server" ContextTypeName="DBDataContext" TableName="News"
        OnSelecting="lnqNew_Selecting" EntityTypeName="">
    </asp:LinqDataSource>
