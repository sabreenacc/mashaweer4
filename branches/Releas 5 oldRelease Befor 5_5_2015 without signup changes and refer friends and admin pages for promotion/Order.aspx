...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <table class="form-block2" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr>
                <td>
                    ...
                    <asp:HiddenField ID="hdnFromZone" ClientIDMode="Static" Value="" runat="server"/>
        ...
        <table class="form-block2" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr>
                <td>
                    ...
                    <asp:HiddenField ID="hdnToZone" ClientIDMode="Static" Value="" runat="server"/>
            ...
            <%--<tr>
                <td>
                    <asp:TextBox ID="PromotionCode" CssClass="txt-box" placeholder="Promotion Code" runat="server"
                        TabIndex="2" onblur="validate(this);"></asp:TextBox>
                </td>
            </tr>--%>
        </table>
        ...
        <table class="form-block2" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr>
                <td>
                    ...
                    <asp:HiddenField ID="hdntotal" ClientIDMode="Static" Value="" runat="server"/>
                    <asp:HiddenField ID="hdndiscount" ClientIDMode="Static" Value="" runat="server"/>
                    ...
                    <select name="select" id="vehicleSelect" runat="server" clientidmode="Static" class="via-select">
                     ...
                     <Label id="lblDiscount" style="margin-left: -1%;display:none;background-color: transparent;display: initial;color: black;" ></Label>
                </td>
            </tr>
        </table>
        <!-- Terms place-->
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(function () {
            ...
            $(".via-select").change(function () {
                calculateprice();
                $("[id$=txtDELIVERYDATE]").val($(".via-select").val());
                        ...
                        $.ajax({
                            ...
                            success: function (msg) {
                                ...
                                if (msg.d === "Yes") {
                                    ...
                                    $("#hdnFromZone").val($("#<%=ddlFromZone.ClientID %>").val());
                                 //   alert($("#hdnFromZone").val());
                                    $("#hdnToZone").val($("#<%=ddlToZone.ClientID %>").val());
                                    // submit
       ...
       <%-- $("#<%=PromotionCode.ClientID %>").focusout(function () {
            calculateprice();
        });
        $("#<%=txtCustEmail.ClientID %>").focusout(function () {
            if ($("#<%=PromotionCode.ClientID %>").val() != "" && $("#<%=PromotionCode.ClientID %>").val() != null) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (parseInt(data, 10) === 0) {
                   ...
                   // alert(data);
                    if (data.indexOf("invalidPromotionCode") >= 0)
                    {
                        alert("1" + data);
                        data = data.replace("invalidPromotionCode", "");
                        $("#tdCost").html(data);
                        $("#hdnCost").val(data);
                        ...
                        $("#lblDiscount").hide();
                        alert("Invalid promotion code to get discount");
                    }
                    else
                   if (data.indexOf("invalidEmail") >= 0) {
                       alert("2" + data);
                        data = data.replace("invalidEmail", "");
                        $("#tdCost").html(data);
                        $("#hdnCost").val(data);
                        ...
                        $("#lblDiscount").hide();
                        alert("Invalid customer email to get discount");
                    }
                    else
                    if (data.indexOf("expired") >= 0)
                    {
                        data = data.replace("expired", "");
                        $("#tdCost").html(data);
                        $("#hdnCost").val(data);
                        ...
                        $("#lblDiscount").hide();
                        alert("Expired promtion code");
                    }
                    else
                        if (data.indexOf("discount") >= 0) {
                           // alert(data);
                        data = data.replace("discount", "");
                        var arr = data.split(',');
                        $("#tdCost").html(arr[2]);
                        $("#hdnCost").val(arr[2]);
                        ...
                        $("#hdndiscount").val(arr[1]);

                        $("#lblDiscount").show();
                        $("#lblDiscount").html("<br /><%=Resources.LanguageFile.PROMOTION_DISCOUNT%>:" + arr[1] + "<br /><br /><%=Resources.LanguageFile.GRANT_TOTAL_COST%>:" + arr[0] + " <%=Resources.LanguageFile.AED%>");
                    }
                    else {
                        $("#tdCost").html(data);
                        $("#hdnCost").val(data);
