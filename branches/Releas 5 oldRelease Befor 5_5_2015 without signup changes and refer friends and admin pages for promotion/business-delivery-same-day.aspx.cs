...
public partial class MashaweerCorporate2 : System.Web.UI.Page
{
    ...
    protected void btnsend_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            mailBody = mailBody.Replace("{Company Name}", CompanyName.Text)
                               ...
                               .Replace("{Title}", " Mashaweer Corporate 2 (Help)");
            ////.Replace("{Delivery date}", txtDELIVERYDATE.Text);


            if (Helper.Mail.SendMail("Mashaweer Corporate 2 (Help)", Setting.SelectValue("ContactEmail"), mailBody, Setting.SelectValue("EmailUserName")))
            {
