<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_FAQs_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="search" width="100%" border="0" cellspacing="0" cellpadding="10px">
            <tr>
                ...
                <td>
                    ...
                    <uc1:ConfirmationMessage ID="cmDialog" Command="FAQ.Delete" runat="server" />
                </td>
                <td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 15px 0 0 0">
        ...
        <tr>
            ...
            <td class="mid">
                ...
                <asp:ListView ID="lvFAQ" runat="server" DataSourceID="lnqFAQ">
                    <LayoutTemplate>
                                    ...
                                    <table id="itemPlaceholderContainer" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr id="Tr2" runat="server" style="">
                                            <th scope="col" width="30%" id="Th1" runat="server">
                                                <asp:LinkButton ID="lnkName" OnClick="Sorting_Click" CommandArgument="Question"
                                                    runat="server">السؤال</asp:LinkButton>
                                            </th>
                    ...
                    <ItemTemplate>
                        <tr class='row<%# (Container.DataItemIndex%2)==0 ? "1" : "2" %>' id='LvRow_<%# Eval("FAQId") %>'>
                            <td style="text-align: right; padding-right: 10px">
                                <%# Eval("Question").ToString().SupName(30) %>
                            </td>
                            ...
                            <td>
                                <a href='addEdit.aspx?ID=<%#Eval("FAQId") %>'>
                                    <img src='/App_Themes/Admin/images/edit-icon.png' width='20' height='20' />
                                </a>
                            </td>
                              <td>
                                <a href='#' onclick='Delete("<%# Eval("FAQId")%>");'>
    ...
    <asp:LinqDataSource ID="lnqFAQ" runat="server" 
        ContextTypeName="DBDataContext" TableName="FAQs" 
        OnSelecting="lnqFAQ_Selecting" EntityTypeName="">
    </asp:LinqDataSource>
