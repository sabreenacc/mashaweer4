...
public partial class MashaIndividual : System.Web.UI.Page
{
    ...
    protected void btnSave_Click1(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            if (Helper.Mail.SendMail("Mashaweer Individual 1 (Help)", Setting.SelectValue("ContactEmail"), mailBody, Setting.SelectValue("EmailUserName")))
            {
    ...
    protected void btnsend_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            if (Helper.Mail.SendMail("Mashaweer Individual (Help)", Setting.SelectValue("ContactEmail"), mailBody, Setting.SelectValue("EmailUserName")))
            {
                Response.Redirect("thankyouLandingPages.aspx");
            }
        }       
