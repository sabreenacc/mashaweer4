<%@ Page Title="MashaIndividual" Language="C#" MasterPageFile="~/Site2ForLandingPages2.master" AutoEventWireup="true"
    CodeFile="errands-delivery-UAE.aspx.cs" Inherits="MashaIndividual" %>

<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    
<div class="page-warp" style="margin-top: -4%">
<div class="left">
    <img src="App_Themes/MainEn/images/Masha-Individual.png" style="width: 38%;float: right;margin-top: 1%;" />
</div>
    
    <div class="right">
        <div id="titlelbl" style="width: 53%;">
        <p class="short-desc2" style="color: #FFFDFD;font-size: 237%;font-weight: bold;line-height: 1em;">
            Mashaweer is here to give you a helping hand. Saving your time, effort, & frustration!!!<br /><font style="color:black">Now you can do more of the things you love.</font>
         </p>
        </div>
           <div class="footer" style="width: 56%;margin-top: 2%;"></div>
    </div>

    <div>
    <div style="  margin-top: 1.1%;">
         <span class="short-desc" style="color:#000;margin-left: -2%;font-size:175%;font-weight: bold;">
       You can relax & let's do it for you!!!!</span>
    </div>
    <br />
        
             <div style="float: left;margin-left: 2%;margin-right: 3%;font-family: 'Helvetica';font-size: 123%;  line-height: 1.2em;">                 
                 <ul style="list-style-type:disc">
                 <li>Balloons & Flowers Delivery.</li>
                 <li>Pick up Cacks.</li>
                 <li>Gift & Presents Delivery.</li>                
             </ul>
             </div>
             <div id="dvLeftList" style="float: left;margin-left: 2%;margin-right: 3%;font-family: 'Helvetica';font-size: 123%;  line-height: 1.2em;">               
                 <ul style="list-style-type:disc">
                 <li>Exchange Clothes.</li>
                 <li>Send Your Laptop for Repair.</li>
                 <li>Even take your car for a wash...</li>
             </ul>
             </div>          

    
    <div>
            <span class="short-desc" style="margin-top: 1%;display: inline-block;color:#000;margin-left: -2%;font-size:175%;font-weight: bold;">
             No task is too big or to small.
            </span> 
     </div>
     </div>   
</div>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="FooterContent">
     <form runat="server">
         <div class="container_" style="background-color:black;">
                 ...
                 <tr>
                    <td>
                        <asp:TextBox ID="ContactPerson" CssClass="txt-box" runat="server" TabIndex="1"
                            placeholder="Contact Person" style="background-color: #ecf0f1;margin-top: 1%;margin-left: 3%;"></asp:TextBox>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="MobileNumber" CssClass="txt-box" placeholder="Mobile Number"
                            runat="server" TabIndex="1" style="background-color: #ecf0f1;margin-top: 4.5%;margin-left: 3%;"></asp:TextBox>
               ...
               <tr>
                    <td>
                        <asp:TextBox ID="EmailAddress" style="background-color: #ecf0f1;margin-top: 4.5%;margin-left: 3%;" CssClass="txt-box" placeholder="Email Address"
                       ...
                       <asp:RegularExpressionValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RegularExpressionValidator1" runat="server" ForeColor="Red"
                        ...
                        <asp:RequiredFieldValidator style="color: Red; font-size: 50%;margin-left: -1%;" ID="RequiredFieldValidator3" runat="server" Display="Dynamic"
                            ErrorMessage="*" ControlToValidate="HowWeCanHelp" ForeColor="Red" ValidationGroup="Valid"></asp:RequiredFieldValidator>
                                                 <asp:Button ID="btnsend" Text="Submit" OnClick="btnsend_Click" style="margin-left: 63%;font-size: 15px;width:88px;margin-top: 3%;background-color: black;" runat="server"  CssClass="normal-btn" ValidationGroup="Valid"/>
                                            </div>
                                         </fieldset>
                                    </div>
