...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="page-content">
        ...
        <table class="contact-table" width="500" border="0" style='margin-top: 20px; margin-bottom: 96px; <asp:Literal ID="ltrlContactTable" Visible="false" runat="server" Text="visibility: hidden;" />'>
            <%--<tr>
