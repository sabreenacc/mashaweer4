    ...
    <div class="page-content">
        ...
        <table class="contact-table" border="0" style='width: 100%; margin-bottom: 25px;
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList class="dropdownZone" ID="ddlFromZone" Style="width: 90%" runat="server"
                ...
                <td>
                    <asp:DropDownList class="dropdownZone" ID="ddlToZone" Style="width: 90%" runat="server"
            ...
            <tr>
                ...
                <td style="line-height: 20px; font-weight: bolder; font-size: 18px; color: #11574B;">
            ...
            <tr>
                ...
                <td colspan="4">
                    ...
                    <recaptcha:RecaptchaControl ID="recaptcha" runat="server" PublicKey="6LdNINcSAAAAAPKpGyyH3Xel6hJtMDWPhquSIJ2r"
                        Theme="clean" PrivateKey="6LdNINcSAAAAACT0p6gFDV38-2DvHfWNy81sbqRs" />

                    <%--<div id="recaptcha" style="width: 280px">
                        <script type="text/javascript">
                            var publicKey = '6LdNINcSAAAAAPKpGyyH3Xel6hJtMDWPhquSIJ2r';
                            Recaptcha.create(
            publicKey
            , "recaptcha"
            , {
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            function calculateprice() {
                $.ajax({
                    url: "/CalculateHandler.ashx?order=1&type=1&db=1&from=" + $("#<%=ddlFromZone.ClientID %>").val() + "&to=" + $("#<%=ddlToZone.ClientID %>").val(),
                    cache: false,
