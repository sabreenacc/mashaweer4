...
public partial class CalculatorMobile : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            Zone fromZone = Mashaweer.MashaweerDatabaseHandler.Single<Zone>(int.Parse(ddlFromZone.SelectedValue));
        ...
        try
        {
            Zone toZone = Mashaweer.MashaweerDatabaseHandler.Single<Zone>(int.Parse(ddlToZone.SelectedValue));
